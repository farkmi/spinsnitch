...
swagger-generate-recognizer-client: ##- Generates the recognizer client based on api/recognizer/openapi.json.
	@echo "make swagger-generate-recognizer-client"
	@rm -rf internal/recognizer
	@mkdir -p internal/recognizer
	@swagger generate client \
		--spec=api/recognizer/openapi.json \
		--target=internal/recognizer \
