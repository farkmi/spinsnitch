...
// tests for PostVinylRoute200Response
void main() {
  // final instance = PostVinylRoute200Response();

  group('test PostVinylRoute200Response', () {
    // String artist
    ...
    // int discogsId
    test('to test the property `discogsId`', () async {
      // TODO
    });
    ...
    // List<String> styles (default value: const [])
    test('to test the property `styles`', () async {
      // TODO
    });

    // String thumbImage
    test('to test the property `thumbImage`', () async {
      // TODO
    });
