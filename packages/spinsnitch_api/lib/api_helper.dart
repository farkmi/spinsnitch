...
String parameterToString(dynamic value) {
  ...
  if (value is OrderDir) {
    return OrderDirTypeTransformer().encode(value).toString();
  }
  if (value is PublicHttpErrorType) {
    return PublicHttpErrorTypeTypeTransformer().encode(value).toString();
  }
  if (value is UserScope) {
    return UserScopeTypeTransformer().encode(value).toString();
  }
